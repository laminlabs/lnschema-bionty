...
class Migration(migrations.Migration):
    replaces = [
        ("bionty", "0001_initial"),
        ("bionty", "0002_rename_gene_type_gene_biotype_and_more"),
        ("bionty", "0003_alter_biontysource_entity_alter_biontysource_source_and_more"),
        ("bionty", "0004_alter_cellline_bionty_source_and_more"),
        ("bionty", "0005_rename_short_name_cellline_abbr_and_more"),
        ("bionty", "0006_alter_biontysource_options_alter_cellline_options_and_more"),
        ("bionty", "0007_rename_readout_experimental_factor"),
        ("bionty", "0008_remove_gene_hgnc_id_remove_gene_mgi_id_and_more"),
        ("bionty", "0009_alter_gene_ensembl_gene_id"),
        ("bionty", "0010_alter_species_name"),
        ("bionty", "0011_cellline_datasets_cellmarker_datasets_and_more"),
        ("bionty", "0012_gene_stable_id"),
        ("bionty", "0013_alter_cellmarker_species_alter_gene_species_and_more"),
        ("bionty", "0014_ethnicity_developmentalstage"),
        ("bionty", "0015_migrate_to_integer_pks"),
        ("bionty", "0016_export_legacy_data"),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "uid",
                    models.CharField(unique=True, default=bionty.ids.biontysource, max_length=8),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "uid",
                    models.CharField(unique=True, default=bionty.ids.species, max_length=4),
                ),
                (
                    "name",
                    models.CharField(db_index=True, default=None, max_length=64, unique=True),
                ),
                (
                    "taxon_id",
                ...
                (
                    "datasets",
                    models.ManyToManyField(related_name="species", to="lnschema_core.dataset"),
                ),
                (
                    "files",
                    models.ManyToManyField(related_name="species", to="lnschema_core.file"),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "uid",
                    models.CharField(unique=True, default=bionty.ids.protein, max_length=12),
                ),
                (
                    "name",
                ...
                (
                    "datasets",
                    models.ManyToManyField(related_name="proteins", to="lnschema_core.dataset"),
                ),
                (
                    "feature_sets",
                ...
                (
                    "files",
                    models.ManyToManyField(related_name="proteins", to="lnschema_core.file"),
                ),
                (
                    "species",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "uid",
                    models.CharField(unique=True, default=bionty.ids.gene, max_length=12),
                ),
                (
                    "symbol",
                    models.CharField(db_index=True, default=None, max_length=64, null=True),
                ...
                (
                    "datasets",
                    models.ManyToManyField(related_name="genes", to="lnschema_core.dataset"),
                ),
                (
                    "feature_sets",
                ...
                (
                    "files",
                    models.ManyToManyField(related_name="genes", to="lnschema_core.file"),
                ),
                (
                    "species",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "uid",
                    models.CharField(unique=True, default=bionty.ids.cellmarker, max_length=12),
                ),
                (
                    "name",
                    models.CharField(db_index=True, default=None, max_length=64, unique=True),
                ...
                (
                    "datasets",
                    models.ManyToManyField(related_name="cell_markers", to="lnschema_core.dataset"),
                ),
                (
                    "feature_sets",
                ...
                (
                    "files",
                    models.ManyToManyField(related_name="cell_markers", to="lnschema_core.file"),
                ),
                (
                    "species",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "uid",
                    models.CharField(unique=True, default=bionty.ids.ontology, max_length=8),
                ),
                ...
                (
                    "datasets",
                    models.ManyToManyField(related_name="tissues", to="lnschema_core.dataset"),
                ),
                (
                    "files",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "datasets",
                    models.ManyToManyField(related_name="phenotypes", to="lnschema_core.dataset"),
                ),
                (
                    "files",
                ...
                (
                    "parents",
                    models.ManyToManyField(related_name="children", to="bionty.phenotype"),
                ),
            ],
            options={
                "unique_together": {("name", "ontology_id")},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "datasets",
                    models.ManyToManyField(related_name="pathways", to="lnschema_core.dataset"),
                ),
                (
                    "feature_sets",
                ...
                (
                    "files",
                    models.ManyToManyField(related_name="pathways", to="lnschema_core.file"),
                ),
                (
                    "genes",
                ...
                (
                    "parents",
                    models.ManyToManyField(related_name="children", to="bionty.pathway"),
                ),
            ],
            options={
                "unique_together": {("name", "ontology_id")},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "datasets",
                    models.ManyToManyField(related_name="experimental_factors", to="lnschema_core.dataset"),
                ),
                (
                    "files",
                    models.ManyToManyField(related_name="experimental_factors", to="lnschema_core.file"),
                ),
                (
                    "parents",
                    models.ManyToManyField(related_name="children", to="bionty.experimentalfactor"),
                ),
            ],
            options={
                "unique_together": {("name", "ontology_id")},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "parents",
                    models.ManyToManyField(related_name="children", to="bionty.ethnicity"),
                ),
            ],
            options={
                "unique_together": {("name", "ontology_id")},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "datasets",
                    models.ManyToManyField(related_name="diseases", to="lnschema_core.dataset"),
                ),
                (
                    "files",
                ...
                (
                    "parents",
                    models.ManyToManyField(related_name="children", to="bionty.disease"),
                ),
            ],
            options={
                "unique_together": {("name", "ontology_id")},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "parents",
                    models.ManyToManyField(related_name="children", to="bionty.developmentalstage"),
                ),
            ],
            options={
                "unique_together": {("name", "ontology_id")},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "datasets",
                    models.ManyToManyField(related_name="cell_types", to="lnschema_core.dataset"),
                ),
                (
                    "files",
                ...
                (
                    "parents",
                    models.ManyToManyField(related_name="children", to="bionty.celltype"),
                ),
            ],
            options={
                "unique_together": {("name", "ontology_id")},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "datasets",
                    models.ManyToManyField(related_name="cell_lines", to="lnschema_core.dataset"),
                ),
                (
                    "files",
                ...
                (
                    "parents",
                    models.ManyToManyField(related_name="children", to="bionty.cellline"),
                ),
            ],
            options={
                "unique_together": {("name", "ontology_id")},
