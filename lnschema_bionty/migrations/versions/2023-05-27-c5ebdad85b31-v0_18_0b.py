...
def upgrade() -> None:
    op.drop_index("ix_bionty_bionty_versions_created_at", table_name="lnschema_bionty_biontyversions")
    op.drop_index("ix_bionty_bionty_versions_created_by", table_name="lnschema_bionty_biontyversions")
    op.drop_index("ix_bionty_bionty_versions_database", table_name="lnschema_bionty_biontyversions")
    op.drop_index("ix_bionty_bionty_versions_database_v", table_name="lnschema_bionty_biontyversions")
    op.drop_index("ix_bionty_bionty_versions_entity", table_name="lnschema_bionty_biontyversions")
    op.drop_index("ix_bionty_bionty_versions_updated_at", table_name="lnschema_bionty_biontyversions")
    ...
    op.drop_index("ix_bionty_cell_line_created_at", table_name="lnschema_bionty_cellline")
    op.drop_index("ix_bionty_cell_line_created_by", table_name="lnschema_bionty_cellline")
    op.drop_index("ix_bionty_cell_line_name", table_name="lnschema_bionty_cellline")
    op.drop_index("ix_bionty_cell_line_ontology_id", table_name="lnschema_bionty_cellline")
    op.drop_index("ix_bionty_cell_line_updated_at", table_name="lnschema_bionty_cellline")
    ...
    op.drop_index("ix_bionty_cell_marker_created_at", table_name="lnschema_bionty_cellmarker")
    op.drop_index("ix_bionty_cell_marker_created_by", table_name="lnschema_bionty_cellmarker")
    op.drop_index("ix_bionty_cell_marker_gene_name", table_name="lnschema_bionty_cellmarker")
    op.drop_index("ix_bionty_cell_marker_gene_symbol", table_name="lnschema_bionty_cellmarker")
    op.drop_index("ix_bionty_cell_marker_name", table_name="lnschema_bionty_cellmarker")
    op.drop_index("ix_bionty_cell_marker_ncbi_gene_id", table_name="lnschema_bionty_cellmarker")
    op.drop_index("ix_bionty_cell_marker_synonyms", table_name="lnschema_bionty_cellmarker")
    op.drop_index("ix_bionty_cell_marker_uniprotkb_id", table_name="lnschema_bionty_cellmarker")
    op.drop_index("ix_bionty_cell_marker_updated_at", table_name="lnschema_bionty_cellmarker")
    ...
    op.drop_index("ix_bionty_cell_type_created_at", table_name="lnschema_bionty_celltype")
    op.drop_index("ix_bionty_cell_type_created_by", table_name="lnschema_bionty_celltype")
    op.drop_index("ix_bionty_cell_type_name", table_name="lnschema_bionty_celltype")
    op.drop_index("ix_bionty_cell_type_ontology_id", table_name="lnschema_bionty_celltype")
    op.drop_index("ix_bionty_cell_type_updated_at", table_name="lnschema_bionty_celltype")
    ...
    op.drop_index("ix_bionty_current_bionty_versions_created_at", table_name="lnschema_bionty_currentbiontyversions")
    op.drop_index("ix_bionty_current_bionty_versions_created_by", table_name="lnschema_bionty_currentbiontyversions")
    op.drop_index("ix_bionty_current_bionty_versions_entity", table_name="lnschema_bionty_currentbiontyversions")
    op.drop_index("ix_bionty_current_bionty_versions_updated_at", table_name="lnschema_bionty_currentbiontyversions")
    op.create_index(
    ...
    op.drop_index("ix_bionty_disease_created_at", table_name="lnschema_bionty_disease")
    op.drop_index("ix_bionty_disease_created_by", table_name="lnschema_bionty_disease")
    op.drop_index("ix_bionty_disease_name", table_name="lnschema_bionty_disease")
    op.drop_index("ix_bionty_disease_ontology_id", table_name="lnschema_bionty_disease")
    op.drop_index("ix_bionty_disease_updated_at", table_name="lnschema_bionty_disease")
    ...
    op.drop_index("ix_bionty_gene_created_at", table_name="lnschema_bionty_gene")
    op.drop_index("ix_bionty_gene_created_by", table_name="lnschema_bionty_gene")
    op.drop_index("ix_bionty_gene_ensembl_gene_id", table_name="lnschema_bionty_gene")
    op.drop_index("ix_bionty_gene_gene_type", table_name="lnschema_bionty_gene")
    op.drop_index("ix_bionty_gene_hgnc_id", table_name="lnschema_bionty_gene")
    op.drop_index("ix_bionty_gene_mgi_id", table_name="lnschema_bionty_gene")
    op.drop_index("ix_bionty_gene_ncbi_gene_id", table_name="lnschema_bionty_gene")
    op.drop_index("ix_bionty_gene_omim_id", table_name="lnschema_bionty_gene")
    op.drop_index("ix_bionty_gene_species_id", table_name="lnschema_bionty_gene")
    op.drop_index("ix_bionty_gene_symbol", table_name="lnschema_bionty_gene")
    op.drop_index("ix_bionty_gene_synonyms", table_name="lnschema_bionty_gene")
    op.drop_index("ix_bionty_gene_updated_at", table_name="lnschema_bionty_gene")
    ...
    op.drop_index("ix_bionty_pathway_created_at", table_name="lnschema_bionty_pathway")
    op.drop_index("ix_bionty_pathway_created_by", table_name="lnschema_bionty_pathway")
    op.drop_index("ix_bionty_pathway_name", table_name="lnschema_bionty_pathway")
    op.drop_index("ix_bionty_pathway_ontology_id", table_name="lnschema_bionty_pathway")
    op.drop_index("ix_bionty_pathway_updated_at", table_name="lnschema_bionty_pathway")
    ...
    op.drop_index("ix_bionty_phenotype_created_at", table_name="lnschema_bionty_phenotype")
    op.drop_index("ix_bionty_phenotype_created_by", table_name="lnschema_bionty_phenotype")
    op.drop_index("ix_bionty_phenotype_name", table_name="lnschema_bionty_phenotype")
    op.drop_index("ix_bionty_phenotype_ontology_id", table_name="lnschema_bionty_phenotype")
    op.drop_index("ix_bionty_phenotype_updated_at", table_name="lnschema_bionty_phenotype")
    ...
    op.drop_index("ix_bionty_protein_created_at", table_name="lnschema_bionty_protein")
    op.drop_index("ix_bionty_protein_created_by", table_name="lnschema_bionty_protein")
    op.drop_index("ix_bionty_protein_ensembl_transcript_ids", table_name="lnschema_bionty_protein")
    op.drop_index("ix_bionty_protein_name", table_name="lnschema_bionty_protein")
    op.drop_index("ix_bionty_protein_ncbi_gene_ids", table_name="lnschema_bionty_protein")
    op.drop_index("ix_bionty_protein_protein_names", table_name="lnschema_bionty_protein")
    op.drop_index("ix_bionty_protein_uniprotkb_id", table_name="lnschema_bionty_protein")
    op.drop_index("ix_bionty_protein_uniprotkb_name", table_name="lnschema_bionty_protein")
    op.drop_index("ix_bionty_protein_updated_at", table_name="lnschema_bionty_protein")
    ...
    op.drop_index("ix_bionty_readout_created_at", table_name="lnschema_bionty_readout")
    op.drop_index("ix_bionty_readout_created_by", table_name="lnschema_bionty_readout")
    op.drop_index("ix_bionty_readout_efo_id", table_name="lnschema_bionty_readout")
    op.drop_index("ix_bionty_readout_updated_at", table_name="lnschema_bionty_readout")
    ...
    op.drop_index("ix_bionty_species_created_at", table_name="lnschema_bionty_species")
    op.drop_index("ix_bionty_species_created_by", table_name="lnschema_bionty_species")
    op.drop_index("ix_bionty_species_name", table_name="lnschema_bionty_species")
    op.drop_index("ix_bionty_species_scientific_name", table_name="lnschema_bionty_species")
    op.drop_index("ix_bionty_species_taxon_id", table_name="lnschema_bionty_species")
    op.drop_index("ix_bionty_species_updated_at", table_name="lnschema_bionty_species")
    ...
    op.drop_index("ix_bionty_tissue_created_at", table_name="lnschema_bionty_tissue")
    op.drop_index("ix_bionty_tissue_created_by", table_name="lnschema_bionty_tissue")
    op.drop_index("ix_bionty_tissue_name", table_name="lnschema_bionty_tissue")
    op.drop_index("ix_bionty_tissue_ontology_id", table_name="lnschema_bionty_tissue")
    op.drop_index("ix_bionty_tissue_updated_at", table_name="lnschema_bionty_tissue")
