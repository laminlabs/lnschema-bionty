...
--- | --- | --- | --- | ---
🐛 Fix clashing reverse accessors between `.previous_runs` and `.run` | [249](https://github.com/laminlabs/lnschema-bionty/pull/249) | [falexwolf](https://github.com/falexwolf) | 2024-06-13 |
